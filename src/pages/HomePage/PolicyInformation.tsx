...
const PolicyInformation: React.FC = () => {
    ...
    return (
        <div style={{backgroundColor: '#fff', margin: '20px'}}>
            ...
            <div style={bodyStyle}>
                <Space style={{marginLeft: '20px',marginRight: '20px', display: 'flex', justifyContent: "space-between"}}>
                    <div style={{width: '400px', height: '310px', backgroundColor: '#fff'}}>
                        <div style={{marginLeft: '14px',marginRight: '14px',display: "flex", justifyContent: "space-between"}}>
                            <span style={{fontSize: '24px', fontWeight: '600'}}>招生政策</span>
                            <RightOutlined />
                        </div>
                        <Divider></Divider>
                        <div>
                    ...
                    <div style={{width: '400px', height: '310px', backgroundColor: '#fff'}}>
                        <div style={{marginLeft: '14px',marginRight: '14px',display: "flex", justifyContent: "space-between"}}>
                            <span style={{fontSize: '24px', fontWeight: '600'}}>工作动态</span>
                            <RightOutlined />
                        </div>
                        <Divider></Divider>
                        <div>
                    ...
                    <div style={{width: '400px', height: '310px', backgroundColor: '#fff'}}>
                        <div style={{marginLeft: '14px',marginRight: '14px',display: "flex", justifyContent: "space-between"}}>
                            <span>
                                <LikeFilled />
                                <span style={{fontSize: '24px', fontWeight: '600', color: '#626f69'}}>  招考热点</span>
                            </span>
                            <RightOutlined />
                        </div>
                        <div style={{
                        ...
                        <div style={{
                            ...
                            fontWeight: '700',
                            color: '#1cb278',
                            background: 'https://t2.chei.com.cn/gaokao/assets/web/images/home-dfz-bg.png',
                            backgroundSize: '100%',
                            cursor: "pointer",
