...
const FilterMenu: React.FC = () => {
  ...
  const handleMajorCategoriesSelect = (selectedCategory: string) => {
    setChoices({majorCategories: majorCategoriesMap.get(selectedCategory) ?? Enum.majorCategories.ALL})
  };

  
  const items: MenuProps['items'] = [
    getItem('专业门类', 'sub1', <GlobalOutlined />, [
      getItem(<MajorCategoriesList onSelect={handleMajorCategoriesSelect} selected={majorCategories}/>, 'g1', null, [], 'group')
    ]),
